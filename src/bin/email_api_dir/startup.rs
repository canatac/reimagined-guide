...
use super::startup_routes::{register_admin_routes, register_auth_routes, register_diag_routes, register_docs_routes, register_external_routes, register_mailbox_routes, register_prometheus_routes};
