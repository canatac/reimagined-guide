...
///   "rule_id": "ABUSE_VOLUME_SPIKE",
///   "rule_name": "Volume sortant anormal",
///   "rule_version": "1.0",
///   "severity": "critical",
///   "confidence": 0.97,
///   "tenant_id": "tenant-42",
...
///   "asn": "AS4134",
///   "signal": {
///     "volume_last_1h": 45000,
///     "volume_baseline_1h": 150,
///     "ratio": 300.0,
///     "threshold_ratio": 10.0
///   },
///   "mode": "enforce",
///   "action": "throttle",
///   "action_duration_s": 3600,
///   "remediation_level": 2,
///   "rolled_back": false,
///   "audit_hash": "sha256:e3b0c44...",
///   "context": { "top_destination": "gmail.com", "unique_rcpt": 12000 },
///   "status": "active"
/// }
/// ```
...
// ---------------------------------------------------------------------------
// Auth event (emitted by email_api login/SMTP auth failures)
// ---------------------------------------------------------------------------
